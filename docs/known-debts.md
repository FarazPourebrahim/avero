...
| Checkbox outline (unchecked), on white and on the page background | `gray-300` on white / `background` (non-text, needs 3:1) | 1.34–1.47 | Chosen on 2026-09-23 for the soft look. Per instance, `className="border-gray-500/80"` restores 3:1 (3.28 on white, 3.07 on the background) |
