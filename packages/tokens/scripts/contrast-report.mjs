...
const PAIRS = [
  ...
  { fg: "gray-400", bg: "white", size: "ui", where: "Switch thumb (off)" },
  ...
  { fg: "text-chrome", bg: "white", size: "normal", where: "Inline price tag" },
  {
    fg: "text-chrome",
    bg: "surface-glass",
    backdrop: "background",
    size: "normal",
    where: "Glass listing card price",
  },
  { fg: "slate-400", bg: "background", size: "normal", where: "Mini report action" },
  { fg: "slate-400", bg: "slate-50", size: "normal", where: "Mini stat labels" },
  {
    fg: "text-muted",
    bg: "background",
    size: "normal",
    where: "Muted meta on the page background",
  },
  {
    fg: "text-muted",
    bg: "surface-glass",
    backdrop: "background",
    size: "normal",
    where: "Opportunity card captions",
  },
  { fg: "text-muted", bg: "gray-50", size: "normal", where: "Chart metric toggles (off)" },
  {
    fg: "text-muted",
    bg: "surface-muted",
    size: "normal",
    where: "Footer about text and copyright",
  },
  { fg: "gray-300", bg: "white", size: "normal", where: "Empty state secondary text" },
  { fg: "amber-600", bg: "amber-50", size: "normal", where: "Soft amber button" },
  { fg: "red-500", bg: "red-50", size: "normal", where: "Liked reaction pill" },
  { fg: "red-500", bg: "background", size: "normal", where: "Sidebar danger item" },
  { fg: "orange-400", bg: "white", size: "normal", where: "Profile meta accent" },
  // Badges and chips
