// Verifies the emitted library: every source module has JS + type output, and every
// "use client" directive in source survives into the emitted JS (required for React Server Components).
