...
/**
 * Custom select (FM-05). The trigger reproduces the listing filter panel (R-06); the listbox is
 * designed from the token system, because the reference only ever renders the closed trigger
 * (deviation V-07).
 */
