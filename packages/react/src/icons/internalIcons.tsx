// Lucide glyphs used inside Avero components, vendored so that lucide-react stays an optional peer.
...
export const ZoomInIcon = createIcon("ZoomInIcon", {
  viewBox: "0 0 24 24",
  mode: "stroke",
  paths: ["M3 11a8 8 0 1 0 16 0a8 8 0 1 0 -16 0", "m21 21-4.35-4.35", "M11 8v6", "M8 11h6"],
});
